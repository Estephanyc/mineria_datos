...
def exportResults(items):
    ...
    headers = [
                ...
                'Rut cliente', 'Dv', 'Nombre cliente',	'Apellido cliente',	'Correo', 'Comuna', 'Dirección', 'Ciudad',
    ...
    for item in items:
        objectCsv  = [ 
                    ...
                    item['rut_cliente'], item['dv'], item['nombre_cliente'], item['apellido_cliente'], item['correo'], item['direccion_cliente'], item['comuna_cliente'], item['ciudad_cliente'],
